# ADR 006: Tratamento de Exceções Global com ControllerAdvice

## Status

**Aceito** - 04 de Junho de 2026

## Contexto

O projeto api-arquitetura-example é uma API REST para gerenciamento de produtos, desenvolvida com Spring Boot 3.4.0 e Java 21. Atualmente, o sistema possui as seguintes características:

- Camadas bem definidas: Controller, Service, Repository
- Exceções lançadas diretamente nas camadas Service e Controller
- Respostas de erro inconsistentes e sem padronização
- Ausência de tratamento global para diferentes tipos de exceções
- Dificuldade na manutenção e evolução do código de tratamento de erros
